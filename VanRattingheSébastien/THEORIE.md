...
Ils servent à vérifier si une variable est plein et juste.
Empty va vérifier si la variable est bien complète tandis que isset va vérifier si elle est juste.
...
Get sert à récupérer les fichier dans la base de données tandis que Post va les envoyer.
On va utilier Get pour un récupérer un user qu'on doit modifier ou récupérer lors d'une connection.
...
Header permet d'ajoouter une balise pointant vers le fichiier php. 
Il faut veiller a ce que les balises soient bien fermées.
